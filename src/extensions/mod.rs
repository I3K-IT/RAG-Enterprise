...
//! such features today), one not (ingestion's chunk enricher wraps
//! Community's own already-shipped heading-injection logic). Either way,
//! the absolute rule from that document's section 7 applies: **no
