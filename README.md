...
```sh
mkdir i3k-rag-engine-v0.1.36-linux-x86_64
tar -xzf i3k-rag-engine-v0.1.36-linux-x86_64.tar.gz -C i3k-rag-engine-v0.1.36-linux-x86_64
cd i3k-rag-engine-v0.1.36-linux-x86_64
